...
const EducationPolicy: NextPage = () => {
  return (
    <Layout>
      <div className="min-h-screen bg-gradient-to-b from-primary via-primary-800 to-primary-900 py-16 pt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-white mb-4 drop-shadow-lg">Education Policy</h1>
            <p className="text-xl text-gray-200 drop-shadow max-w-3xl mx-auto">
              Shaping the future of education through youth-led policy initiatives and research.
            </p>
          </div>
            ...
            <div className="bg-white rounded-xl shadow-2xl p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-primary-800">Digital Learning Access</h3>
                    <p className="text-gray-600">Expanding access to digital learning resources in underserved communities.</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <svg className="h-6 w-6 text-secondary mr-2 flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div>
                    <h3 className="font-semibold text-primary-800">STEM Education</h3>
                    <p className="text-gray-600">Promoting STEM education and career pathways for youth.</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <svg className="h-6 w-6 text-secondary mr-2 flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div>
                    <h3 className="font-semibold text-primary-800">Educational Equity</h3>
                    <p className="text-gray-600">Working towards equal educational opportunities for all students.</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-2xl p-8">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-gray-600 mb-2">The State of Digital Education 2024</p>
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-gray-600 mb-2">Improving Educational Outcomes Through Technology</p>
                  <button className="text-secondary hover:text-secondary-700 font-medium">
                    Read More →
                  </button>
                </div>
          ...
          <div className="bg-white rounded-xl shadow-2xl p-8 mb-16">
            ...
            <p className="text-gray-600 text-center mb-8 max-w-2xl mx-auto">
              Join our education policy initiatives and help shape the future of learning. We welcome students, educators, and policy enthusiasts.
            </p>
